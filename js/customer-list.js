...
{
	var batchActionSelect = document.getElementById("batchActionSelect");
	if (batchActionSelect.options[batchActionSelect.selectedIndex].value == 'transfer') {
		$("#batchTransferModal").modal();
	}
	else if (batchActionSelect.options[batchActionSelect.selectedIndex].value == 'disable') {
		$("#batchDisableConfirmModal").modal();
	}
}
